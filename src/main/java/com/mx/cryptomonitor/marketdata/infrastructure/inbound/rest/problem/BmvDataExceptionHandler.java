...
import com.mx.cryptomonitor.marketdata.infrastructure.inbound.rest.BmvDataController;
import com.mx.cryptomonitor.shared.infrastructure.problem.ApiProblemDetailsFactory;

import jakarta.servlet.http.HttpServletRequest;

@RestControllerAdvice(assignableTypes = BmvDataController.class)
public class BmvDataExceptionHandler {
