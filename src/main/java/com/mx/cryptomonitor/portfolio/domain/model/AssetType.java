...
public enum AssetType {
  ...
  FUTURES("Futures", "Contratos de futuros sobre materias primas, índices o divisas", "futures"),
  FOREX("Forex", "Pares de divisas del mercado cambiario", "forex"),
  BONDS("Bonds", "Bonos gubernamentales y corporativos", "bonds");
  ...
  /**
   * Convierte un string al enum, manejando alias históricos (INDICE → INDEX). Lanza excepción para
   * valores nulos o en blanco; usa {@link #fromSafe} si el valor puede ser desconocido.
   */
  public static AssetType from(String value) {
    ...
    // Alias históricos registrados en transaction.domain.model.AssetType
   ...
   * cuando el valor no corresponde a ningún tipo conocido (ej. "BONOS"). Permite que el portafolio
   * histórico ignore tipos que aún no tienen lógica de precios, sin romper el flujo.
   */
